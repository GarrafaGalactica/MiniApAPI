...
#postgresql://postgres:in8AIOENNDP5GGy@dssdapi-db.internal:5433/dssdapi Para cuando subo la imagen
...
class ProductionConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = (f"postgresql://postgres:in8AIOENNDP5GGy@dssdapi-db.internal:5433/dssdapi")
